...
export function MapControl({
  ...
  useEffect(() => {
    ...
    const loadLibraries = async () => {
      try {
        ...
        console.warn(
          "Google Maps libraries failed to load (possibly due to billing).",
          e,
        );
      }
    };
  ...
  const mapVehicles = useMemo(
    () => selectMapVehicles(state, trackedVehicleIds, isMainMap),
    [state, trackedVehicleIds, isMainMap],
  );
          ...
          <>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <div className="w-6 h-6 rounded-full flex items-center justify-center shadow-lg border-2 border-card bg-destructive">
