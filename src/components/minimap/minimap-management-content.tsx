        ...
        <div className="flex items-center gap-2">
            ...
            <div>
                ...
                <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-bold">
                    {miniMaps.length} Grupos / {visibleMiniMapIds.length} Activos
                </p>
            </div>
        </div>
                ...
                miniMaps.map((map) => {
                    ...
                    return (
                        <div key={map.id} className={cn(
                            "p-4 rounded-xl border bg-card shadow-sm space-y-3 transition-all",
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold uppercase text-muted-foreground">Unidades</label>
                                <MultiSelect
