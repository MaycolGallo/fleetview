...
export function MiniMapOverlayGrid({ apiKey }: { apiKey: string }) {
   ...
   * - max-h-[80vh] limits the height to 80% of viewport.
   * - Items use h-[18vh] aspect-square. This ensures 4 items (18*4 = 72vh + gaps) 
   *   always fit in the 80vh container and shrink with the viewport.
   */
  return (
      ...
      <AnimatePresence mode="popLayout">
        {showOverviewAsMini && (
          <motion.div 
            ...
            className="pointer-events-auto relative h-[18vh] aspect-square border-2 rounded-2xl overflow-hidden shadow-2xl bg-card ring-2 ring-primary/20"
          >
        ...
        {activeMiniMaps.map((map) => (
          <motion.div 
            ...
            className="pointer-events-auto relative h-[18vh] aspect-square border-2 rounded-2xl overflow-hidden shadow-2xl bg-card ring-2 ring-primary/10"
          >
